...
void PPPoSComponent::setup() {
  ...
  this->ppp_control_block_ =
      pppos_create(&this->ppp_netif_, PPPoSComponent::output_callback, PPPoSComponent::status_callback, nullptr);
...
network::IPAddresses PPPoSComponent::get_ip_addresses() {
  network::IPAddresses addresses;
  addresses[0] = network::IPAddress(this->ppp_netif_.ip_addr.addr);
  return addresses;
}
